...
*/
//
// Flow graphs are Event Emitters, providing signals when the graph
// definition changes.
//
...
// This class represents an abstract Flow graph containing nodes
// connected to each other with edges.
//
// These graphs can be used for visualization and sketching, but
// also are the way to start a Flow network.
class Graph extends EventEmitter {
  ...
  addExport(publicPort, nodeKey, portKey, metadata = {x:0,y:0}) {
    platform.deprecated('Flow.Graph exports is deprecated: please use specific inport or outport instead');
  ...
  // a node may contain information on what Flow component it is and
  ...
  // to components at Flow network start-up time. This could include
...
module.exports.createGraph = function(name, options) {
  return new Graph(name, options);
}

module.exports.loadJSON = function(definition, callback, metadata = {}) {
...
module.exports.loadFBP = function(fbpData, callback, metadata = {}, caseSensitive = false) {
  try {
...
module.exports.loadHTTP = function(url, callback) {
...
module.exports.loadFile = function(file, callback, metadata = {}, caseSensitive = false) {
  if (platform.isBrowser()) {
...
module.exports.equivalent = function(a, b, options = {}) {
...
module.exports.mergeResolveTheirs = mergeResolveTheirsNaive;