...
module.exports.ArrayPort = require('./ArrayPort').ArrayPort;
module.exports.AsyncComponent = require('./AsyncComponent').AsyncComponent;

ports = require('./Ports');
module.exports.InPorts = ports.InPorts;
module.exports.OutPorts = ports.OutPorts;
